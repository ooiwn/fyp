...
public class DefineTracker extends AppCompatActivity implements DurationDialog.DurationListener {
    ...
    TextView trackerName, trackerUnit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        trackerFrequency.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(DefineTracker.this);
                String[] list = DefineTracker.this.getResources().getStringArray(R.array.frequency_items);
        ...
        trackerTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // time picker dialog
                timePicker = new TimePickerDialog(DefineTracker.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(name) && !TextUtils.isEmpty(unit) && !TextUtils.isEmpty(duration)
                        && !TextUtils.isEmpty(frequency) && !TextUtils.isEmpty(time)) {
                    tracker = new Tracker();
                    ...
                    Toast.makeText(DefineTracker.this, "Please fill in all details", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onPositiveButtonClicked(String[] list, int position) {
        ...
        if (position == 1) {
            ...
            untilDatePicker.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    new DatePickerDialog(DefineTracker.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH)).show();
                }
            });
        } else {
            untilDate.setVisibility(View.GONE);
